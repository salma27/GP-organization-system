    ...
    return (
        <>
            ...
            >
                <defs>
                    <linearGradient
                        id="b3f40125-0363-42ff-a31c-61eb5d655202-261"
                        x1="116.72"
                        y1="237.98"
                        x2="116.72"
                        y2="6.21"
                ...
                <path
                    ...
                    fill="#00bfa6"
                ></path>
                <circle cx="115.85" cy="118.96" r="50.29" fill="#333"></circle>
                <path
                ...
                <path
                    ...
                    fill="#00bfa6"
                ></path>
                <circle cx="384.09" cy="113.27" r="50.29" fill="#333"></circle>
                <path
                ...
                <path
                    ...
                    fill="#00bfa6"
                ></path>
                <circle cx="115.01" cy="363.6" r="54.76" fill="#333"></circle>
                <path
